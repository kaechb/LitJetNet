...
#SBATCH --chdir=/home/kaechben/slurm/new_age        # directory must already exist!
...
. conda-init
conda activate nosegfaultspls
#source /beegfs/desy/user/kaechben/.conda/envs/ok/bin/activate
# gcc/9.3
...
path=JetNet_NF
python -u /home/$USER/$path/LitJetNet/LitNF/main.py #/beegfs/desy/user/kaechben/.conda/envs/ok/bin/
