...
class Block(nn.Module):
    def __init__(self, embed_dim=128, num_heads=8, ffn_ratio=4,
                 ...
                 scale_fc=True, scale_attn=True, scale_heads=False, scale_resids=False):
        super().__init__()
        ...
        self.attn=SelfAttention(dim=embed_dim,heads=num_heads,nb_features=self.ffn_dim,causal=False)#nn.MultiheadAttention(
#             embed_dim,
#             num_heads,
#             dropout=attn_dropout,
#             add_bias_kv=add_bias_kv,
    ...
    def forward(self, x, x_cls=None, padding_mask=None, attn_mask=None):
        ...
        if x_cls is not None:
            ...
            x = self.attn(x, x, x, key_padding_mask=padding_mask,
                         ) #[0]#(seq_len, batch, embed_dim)  attn_mask=attn_mask
            print(x.shape)
